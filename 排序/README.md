...
增量开始为gap=length/2，缩小增量继续以gap = gap/2的方式，直到gap=1后,当gap为1时这时候也就相当于对整个数组进行插入排序</br>
#### 4.1 算法描述
...
```
在JavaScript中这种排序的递归深度太深，所有还有非递归实现！！！这里不做介绍了~~ </br>
...
[几种排序算法时间复杂度，空间复杂度，稳定性比较](https://www.jianshu.com/p/784f5ef0d27f) </br>
